...
{
    class InstanceBlockMenuRandomisationManager : AbstractMenuManager
    {
        ...
        {
            dataCtl.CreateSpacialRandomConditions();

            //TODO
            dataCtl.CreatePracticeSpacialRandomConditions();
            ...
            dataCtl.SetFilename(result_dir, "Exp3_Sub" + SubId, SubId);
        ...
        public void ExperimentStart(int menuId)
        {
            ...
            if (menuId == 0)
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/DurationRandomise/E3_1_practice").text;// neeed to rewrite
            ...
            else if (menuId == 1 )
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/DurationRandomise/E3_2_training").text; // neeed to rewrite
            ...
            else
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/DurationRandomise/E3_3_main").text;// neeed to rewrite
