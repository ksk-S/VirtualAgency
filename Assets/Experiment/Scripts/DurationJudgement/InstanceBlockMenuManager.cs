...
{
    class InstanceBlockMenuManager : AbstractMenuManager
    {
        ...
        public void ExperimentStart(int menuId)
        {
            ...
            if (menuId == 0)
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/Duration/practice").text;// neeed to rewrite
            ...
            else if (menuId == 1 )
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/Duration/training").text; // neeed to rewrite
            ...
            else
            {
                ...
                InstructionText.text += Resources.Load<TextAsset>("Texts/Duration/main").text;// neeed to rewrite
