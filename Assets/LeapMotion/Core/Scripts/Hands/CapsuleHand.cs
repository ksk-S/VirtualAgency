...
namespace Leap.Unity {
  ...
  public class CapsuleHand : HandModelBase {
    ...
    public SpatialRandomisationHelper randomHelper = new SpatialRandomisationHelper();
    public bool isHideCylinders = false;
    ...
    private static Color[] _rightColorList = { new Color(0.0f, 0.0f, 1.0f)};
    ...
    public void StartRandomise()
    {
       randomHelper.StartSpaceRandom(_spherePositions);
    }
    public void StopRandomise()
    {
        randomHelper.StopSpaceRandom();
    }
    ...
    public override void UpdateHand() {
      if (_spherePositions == null || _spherePositions.Length != TOTAL_JOINT_COUNT + 2) {
        _spherePositions = new Vector3[TOTAL_JOINT_COUNT + 2];
      }
      ...
      _spherePositions[TOTAL_JOINT_COUNT + 0] = palmPosition;
     ...
     _spherePositions[TOTAL_JOINT_COUNT + 1] = mockThumbJointPos;
      //drawSphere(mockThumbJointPos);

      for (int id = 0; id < TOTAL_JOINT_COUNT + 2; id++) {
         drawSphere(randomHelper.ConvertCoordinate(id, _spherePositions[id]));
      }
