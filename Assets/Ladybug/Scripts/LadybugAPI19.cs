...
namespace LadybugAPI19
{
    ...
    */
    ...
    {
		private const string LADYBUG_DLL = "Ladybug\\1.9\\ladybug";
        ...
        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetToneMapping")]
        public static extern LadybugError SetToneMapping(int context, bool enable);

        [DllImport(LADYBUG_DLL, EntryPoint = "ladybugSetToneMappingParams")]
        public static extern LadybugError SetToneMappingParams(int context, LadybugToneMappingParams enable);
    ...
    {
		private const string LADYBUG_GUI_DLL = "Ladybug\\1.9\\ladybugGUI";
